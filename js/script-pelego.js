...
async function calcular() {
    ...
    try {
        ...
        const couroAnteriorCardHTML = tier > 2 ? `<div class="bg-gray-700 p-4 rounded-lg text-center shadow-lg hover:shadow-xl transition-shadow"><h3 class="font-semibold mb-2 text-blue-300">Couro T${tier - 1}${temEncCouroAnterior ? '.' + enc : ''}</h3><img src="icons/T${tier - 1}_LEATHER${encSuffixCouroAnteriorHTML}.png" class="mx-auto h-24 mb-2" alt="Couro Anterior" onerror="this.src='icons/default.png'"><p class="text-xl font-bold">$${formatarValor(precoCouro)}</p><p class="text-sm text-gray-400">por unidade</p></div>` : '';
        ...
        document.getElementById("resultado").innerHTML = `
            ...
            <div class="grid grid-cols-1 ${tier > 2 ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-4 mb-6">
                <div class="bg-gray-700 p-4 rounded-lg text-center shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <img src="icons/T${tier}_HIDE${enc > 0 ? '_LEVEL' + enc + '_' + enc : ''}.png" class="mx-auto h-24 mb-2" alt="Pelego" onerror="this.src='icons/default.png'">
                ...
                <div class="bg-gray-700 p-4 rounded-lg text-center shadow-lg hover:shadow-xl transition-shadow">
                    ...
                    <img src="icons/T${tier}_LEATHER${enc > 0 ? '_LEVEL' + enc + '_' + enc : ''}.png" class="mx-auto h-24 mb-2" alt="Couro Atual" onerror="this.src='icons/default.png'">
